...
import zav.jra.endpoints.Listings;
...
public abstract class Client extends ClientTOP{
    ...
    @Override
    public zav.jra.Account getAccount(String name, Parameter... params) throws InterruptedException, IOException {
        QueryGet<zav.jra.Account> query = Users.getAccount(this, () -> zav.jra.Account.from(this), name);
